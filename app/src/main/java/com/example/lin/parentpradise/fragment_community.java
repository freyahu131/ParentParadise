...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        RecyclerView recyclerView = (RecyclerView) findViewById(R.id.recycleView_friends);
        recyclerView.setLayoutManager( // recycleView有manager
                new StaggeredGridLayoutManager( //壹定要設！！！
                        1, StaggeredGridLayoutManager.horizatonal));// 2的意思是水平兩行
        List<MayFriend> List = getMemberList();
    ...
    public List<Member> getMemberList() {
        ...
        memberList.add(new Member(, R.drawable.p01, "John"));
